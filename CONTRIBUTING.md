...
some other ruleset that depends on rules_uniffi, or in a nested
...
```sh
OVERRIDE="--override_repository=rules_uniffi=$(pwd)/rules_uniffi"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@rules_uniffi` on your system will point to this folder.
