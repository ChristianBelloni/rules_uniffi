...
is interpreted as the line width) _and_ a full `Options` object. This
...
feature is not enabled. This is a _breaking change_ for users of
...
`Wrapper::word_splitter` method has been removed. This is a _breaking
API change_ if you used the method to change the word splitter.
...
borrow data from the input string. This is a _breaking API change_ if
...
Version 0.5.0 has _breaking API changes_. However, this only affects
